...
def enter_dual_level():
    ...
    """
    from torch._functorch.predispatch import _enter_dual_level as _predispatch_enter_dual_level
...
def exit_dual_level(*, level=None):
    ...
    from torch._functorch.predispatch import _exit_dual_level as _predispatch_exit_dual_level
