...
class NodeEventTracker:
    ...
    def print_all(self, writer: Any = None) -> None:
        """
...
def generate_inputs_for_submodules(
    ...
    def pre_forward(module: torch.nn.Module, module_inputs: Any) -> None:
...
class _SplitterBase:
    ...
    def node_support_preview(self, dump_graph: bool = False) -> str:
        ...
        def get_dtype(arg: torch.fx.Node) -> Any:
        ...
        for node in split_mod.graph.nodes:
            if node.op == "call_module" and "acc" in node.target:
                ...
                def get_submod_inputs(
                    ...
                    def get_inputs(self: Any, inputs: Any) -> None:
                        nonlocal sub_inputs
                        sub_inputs = inputs
