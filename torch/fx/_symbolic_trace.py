...
def _transfer_attrs(fr: Any, to: Any) -> None:
...
def _find_proxy(*objects_to_search: Any) -> Proxy | None:
    """
...
def _create_wrapped_func(orig_fn: Callable[..., Any]) -> Callable[..., Any]:
...
@wrap
def _assert_is_none(value: Any, msg: str) -> None:
