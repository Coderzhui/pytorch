...
class GraphModule(torch.nn.Module):
    ...
    @compatibility(is_backward_compatible=True)
    def __init__(  # pyrefly: ignore[unannotated-return]
        self,
        ...
        self._replace_hooks: list[Callable[..., Any]] = []
        self._create_node_hooks: list[Callable[..., Any]] = []
        self._erase_node_hooks: list[Callable[..., Any]] = []
        # Used to remove hooks from deepcopied graph modules within a context manager.
        self._deepcopy_hooks: list[Callable[..., Any]] = []
...
"""
    ...
    def recompile(self) -> PythonCode:
        ...
        ) -> Any:  # pyrefly: ignore[unannotated-parameter]
    ...
    def _set_replace_hook(self, f: Callable[..., Any]) -> Generator[None, None, None]:
        """
    ...
    def _register_replace_node_hook(self, f: Callable[..., Any]) -> None:
        """
        Takes a callable which will be called every time when we replace a node
        to a new node, or change the node's name. Callable takes three arguments:
        the old node we're changing, and NAME of the new node, followed by the
    ...
    def _unregister_replace_node_hook(self, f: Callable[..., Any]) -> None:
        """
    ...
    def _register_create_node_hook(self, f: Callable[..., Any]) -> None:
        """
    ...
    def _unregister_create_node_hook(self, f: Callable[..., Any]) -> None:
        """
    ...
    def _register_erase_node_hook(self, f: Callable[..., Any]) -> None:
        """
    ...
    def _unregister_erase_node_hook(self, f: Callable[..., Any]) -> None:
        """
    ...
    def _register_deepcopy_hook(self, f: Callable[..., Any]) -> None:
        """
    ...
    def _unregister_deepcopy_hook(self, f: Callable[..., Any]) -> None:
        """
