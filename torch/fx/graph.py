...
class CodeGen:
    ...
    def _get_delimiters(self, container: object) -> tuple[str, str]:
    ...
    def _gen_python_code(
        ...
        *,
        ...
        def add_global(name_hint: str, obj: object) -> str:
            ...
            """
            if (
                callable(obj) and _is_from_torch(obj) and obj != torch.device
...
class _FindNodesLookupTable:
    ...
    def find_nodes(
        self, *, op: str, target: Target | None = None
...
class Graph:
    ...
    @compatibility(is_backward_compatible=False)
    def find_nodes(  # pyrefly: ignore[unannotated-return]
    ...
    @compatibility(is_backward_compatible=True)
    def inserting_before(
        self, n: Node | None = None
    ):  # pyrefly: ignore[unannotated-return]
    ...
    @compatibility(is_backward_compatible=True)
    def print_tabular(self):  # pyrefly: ignore[unannotated-return]
        """
    ...
    @compatibility(is_backward_compatible=True)
    def lint(self):  # pyrefly: ignore[unannotated-return]
        """
